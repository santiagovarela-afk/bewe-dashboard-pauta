...
const RULES: Rule[] = [
  { text: "Mínimo €9/día por adset · si un conjunto no sostiene ese piso lo fusionamos o lo apagamos. Nada de adsets famélicos que nunca salen de aprendizaje.", tone: "ember" },
  { text: "Belleza siempre con 2 LOK adsets: uno con ganadores (mantiene el aprendizaje) y otro con creativos nuevos (no contamina el ganador).", tone: "violet" },
  ...
  { text: "No miramos solo registros baratos: miramos cuáles llegan a trial. Regla: 50% de leads tienen que convertir a trial (medimos CPT).", tone: "violet" },
...
const BREAKDOWN: CampaignBreakdown[] = [
  {
    ...
    adsets: [
      {
        name: "A1.1 LOK Belleza · Ganadores",
        audience: "Lookalike",
        perDay: "50%",
        cplMay: "€5.03",
        action: "ESCALAR",
        note: "Activo hoy en cuenta · mejor LOK de MX · carga los ángulos validados de mayo (mkt + paraguas + linda).",
      },
      {
        name: "A1.5 LOK Belleza · Test Creativos",
        audience: "Lookalike",
        perDay: "50%",
        cplMay: null,
        action: "NUEVO",
        note: "Misma audiencia Lookalike pero adset separado para probar los videos perro-mucho (no contaminamos el de ganadores).",
      },
    ],
    ads: "Ganadores: mkt + paraguas (reemplazar por VIDEO · fatigado 68K impr). Test creativos: 3 videos perro-mucho + 2 videos belleza nuevos.",
    role: "motor",
    status: "Activa",
  },
  {
    ...
    adsets: [
      {
        name: "A4.1 LOK Belleza · Ganadores",
        audience: "Lookalike",
        perDay: "50%",
        cplMay: "€7.13",
        action: "MANTENER",
        note: "Activo hoy · rey del volumen · trae más leads que cualquier otro adset · ángulos validados (mkt + paraguas LATAM).",
      },
      {
        name: "A4.5 LOK Belleza · Test Creativos",
        audience: "Lookalike",
        perDay: "50%",
        cplMay: null,
        action: "NUEVO",
        note: "Misma audiencia LOK pero adset separado para los videos perro-mucho LATAM · medir si los nuevos baten al ganador.",
      },
    ],
    ads: "Ganadores: mkt_v1_dol (volumen 71K impresiones) + paraguas LATAM (€5.49). Test creativos: 3 videos perro-mucho LATAM + 2 piezas refresh.",
    role: "motor",
    status: "Activa",
  },
  {
    ...
    adsets: [
      {
        name: "LOK Belleza CP · Ganadores",
        audience: "Lookalike",
        perDay: "50%",
        cplMay: null,
        action: "NUEVO",
        note: "Mismo perfil Lookalike que funciona en Ventas pero con objetivo Clientes Potenciales · ángulos validados de mayo.",
      },
      {
        name: "LOK Belleza CP · Test Creativos",
        audience: "Lookalike",
        perDay: "50%",
        cplMay: null,
        action: "NUEVO",
        note: "Adset paralelo para probar los 6 videos perro-mucho en objetivo CP · ver si arrancan a CPL bajo de entrada.",
      },
    ],
  ...
  },
  {
    ...
    adsets: [
      {
        name: "A3.1 LOK Servicios · Concentrado",
        audience: "Lookalike",
        perDay: "100%",
        cplMay: "€3.98",
        action: "ESCALAR",
        note: "Activo hoy · el MEJOR adset de toda la cuenta · consolidamos todo el budget aquí. El conjunto de Interés (€5.49 OK pero más caro) se apaga para no fraccionar y respetar el mínimo €9/día por adset.",
      },
    ],
